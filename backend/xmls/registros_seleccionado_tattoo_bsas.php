...
// 	if( $_SESSION['validado'] === true ){
	include('../r/r.php');
	$er=true;
	(isset($_GET['numero_usuario']) && $_GET['numero_usuario'] != '') ? $numero_usuario = $_GET['numero_usuario'] : $er=false;
	if ($er) 
	{
		...
		$sql 			=   'SELECT	
							...
							FROM `_iristattoo_formulario_autorizacion` WHERE (estado = 1 AND pais = "bsas") AND `id` = '.$numero_usuario.'';
