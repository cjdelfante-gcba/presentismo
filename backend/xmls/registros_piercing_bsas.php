...
// 	if( $_SESSION['validado'] === true ){
		...
		$sql 			= 	'SELECT	
								...
								`hiv` AS hiv_cl,
								`hiv_observaciones` AS hiv_observaciones_cl,
								...
								`zona_aplicacion_piercing` AS zona_aplicacion_cl,
								`descripcion_joya` AS descripcion_jpya_cl,
								`piercing` AS piercing_cl,
								`fecha_creacion` AS fecha_creada_cl,
								`consumo_alcohol` AS alcohol_cl,
								`consumo_alcohol_observaciones` AS alcohol_observaciones_cl
							FROM `_formulario_autorizacion_iristatoo` WHERE estado = 1 AND pais = "miami"';
